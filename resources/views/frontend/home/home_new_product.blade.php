@php
    $products = \App\Models\Product::with('vendor')->with('category')->where('status', 1)->orderBy('id','ASC')->limit(5)->get();
                ...
                @foreach($categories as $category)
                    <li class="nav-item" role="presentation">
                        <a class="nav-link " id="nav-tab-two" data-bs-toggle="tab"
                           ...
                           aria-controls="tab-two" aria-selected="false">{{$category->category_name}}
                        </a>
                    </li>
                @endforeach
            </ul>
                            ...
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="product-card-bottom">
                                        ...
                                        @endif
                                        <div class="add-cart">
                                            <a type="submit" class="add" onclick="addToCartDetails()"><i
