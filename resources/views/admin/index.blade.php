...
@section('admin')
    ...
    $vendor = App\Models\User::where('role','vendor')->where('status','active')->count();
    $customer = App\Models\User::where('role','user')->where('status','active')->count();
    @endphp
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-ibiza">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white">{{ $vendor }}</h5>
                            <div class="ms-auto">
                                <i class='bx bx-envelope fs-3 text-white'></i>
                            </div>
                        </div>
