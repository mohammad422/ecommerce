@php
    $vendors = \App\Models\User::with('products')->where('role','vendor')->where('status','active')->orderBy('id','DESC')->limiT(4)->get();
@endphp
<div class="container">
                    ...
                    <div class="vendor-img-action-wrap">
                        <div class="vendor-img">
                            <a href="{{route('vendor.details', $vendor->id)}}">
                                <img class="default-img" style="width: 120px; height: 120px;" src="{{!empty($vendor->photo) ? url('upload/vendor_images/'.$vendor->photo):url('upload/no_image.jpg')}}"
                                     alt=""/>
                            </a>
                        </div>
